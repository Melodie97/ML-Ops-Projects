...
from Dagster_Demo_project.assets import (
...
def test_smoke():
    ...
    # mock out the read process
    github_api = MagicMock()
    github_api.get_repo("Melodie97/100daysofcode-Python").get_stargazers_with_dates.return_value = [
        MagicMock(
